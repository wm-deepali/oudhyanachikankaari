                ...
                <div class="card-body">
                    ...
                    <form id="blogForm" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="form-group mt-3">
                            ...
                            @if($blog->image)
                                <img src="{{ asset('uploads/blogs/' . $blog->image) }}" width="120" class="mt-2">
                            @endif
                        ...
                        <div class="form-group mt-3">
                            ...
                            <div class="custom-control custom-checkbox">
                                ...
                                <input type="checkbox" name="show_home" id="show_home" class="custom-control-input" {{ $blog->show_home ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-checkbox mt-2">
                                ...
                                <input type="checkbox" name="status" id="status" class="custom-control-input" {{ $blog->status ? 'checked' : '' }}>
