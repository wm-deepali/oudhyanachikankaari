    ...
    <div class="app-content content container-fluid">
        <div class="create-page">
            ...
            <form id="slideForm" method="POST" enctype="multipart/form-data"
                  action="{{ route('admin.home-hero-slides.update', $item->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="create-layout">
                        ...
                        <div class="section-card">
                            ...
                            <div class="section-card-body">
                                ...
                                <div class="field-group">
                                    ...
                                    <input type="text" name="subtitle" class="field-input" value="{{ old('subtitle', $item->subtitle) }}">
                                </div>

                                <div class="field-group">
                                    <label class="field-label">Title</label>
                                    <input type="text" name="title" class="field-input" value="{{ old('title', $item->title) }}">
                                </div>

                                <div class="field-group">
                                    <label class="field-label">Description</label>
                                    <textarea name="description" class="field-textarea" rows="5"
                                              placeholder="Supporting copy shown below the title…">{{ old('description', $item->description) }}</textarea>
                                </div>

                                <div class="field-row">
                                    <div class="field-group">
                                        <label class="field-label">Button Text</label>
                                        <input type="text" name="button_text" class="field-input" value="{{ old('button_text', $item->button_text) }}">
                                    </div>
                                    <div class="field-group">
                                        <label class="field-label">Button Link</label>
                                        <input type="text" name="button_link" class="field-input" value="{{ old('button_link', $item->button_link) }}" placeholder="https://…">
                                    </div>
                                </div>
                    ...
                    <div>
                        ...
                        <!-- Image upload -->
                        <div class="section-card">
                            <div class="section-card-header"><h5>Slide Image</h5></div>
                            <div class="section-card-body">
                                <div class="upload-area" id="uploadArea">
                                    ...
                                    @if($item->image)
                                        <div class="upload-preview" id="uploadPreview">
                                            <img id="previewImg" src="{{ asset('storage/'.$item->image) }}" alt="{{ $item->title }}">
                                ...
                                @if($item->image)
                                    <div class="current-icon-note">
                                        <i class="fa fa-info-circle"></i> Current image shown above — upload a new file to replace it.
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="section-card">
                            ...
                            <div class="section-card-body">
                                ...
                                <div class="field-group">
                                    ...
                                    <input type="number" name="sort_order" class="field-input" value="{{ old('sort_order', $item->sort_order) }}">
                ...
                <div class="action-bar">
                    ...
                    <button type="submit" id="saveBtn" class="btn-primary-dash">
                        <i class="fa-solid fa-save"></i> Update Hero Slide
                    </button>
                </div>
