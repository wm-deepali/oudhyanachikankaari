...
<div class="main-section">
    ...
    .col-identity-name { font-size: 14px; font-weight: 650; color: var(--text-primary); max-width: 200px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
    .col-identity-id   { font-size: 12px; color: var(--text-hint); margin-top: 2px; }
                ...
                <div class="edit-layout">
                    ...
                    <div>
                        <div class="section-card">
                            <div class="section-card-header"><h5>Collection Details</h5></div>
