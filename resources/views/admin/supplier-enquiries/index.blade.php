        ...
        <div class="list-page">
            ...
            <div class="list-page-header">
                ...
                <div style="display:flex;gap:8px;flex-wrap:wrap;align-items:center;">
                    <a href="{{ route('admin.supplier-enquiries.export') }}" class="btn-green">
                        ...
                        <tbody>
                            ...
                            @forelse($enquiries as $key => $item)
                                ...
                                <tr id="row{{ $item->id }}">
                                    ...
                                    <td>
                                        @if($item->category)
                                            <span class="inq-tag">{{ $item->category->name }}</span>
                                        @else
                                ...
                                <tr>
                                    <td colspan="9">
                                        <div class="empty-state">
                                            ...
                                            <p>Bulk Enquiries form submissions will appear here.</p>
                                        </div>
                                    </td>
                                </tr>
...
function deleteEnquiry(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: `/admin/supplier-enquiries/${id}`,
                type: "DELETE",
...
function bulkDelete() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "{{ route('admin.supplier-enquiries.bulk-delete') }}",
                type: "DELETE",
