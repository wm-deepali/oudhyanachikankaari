...
<div class="main-section">
    ...
    .cav-page { background: var(--bg); padding: 24px 28px; min-height: 100vh; font-family: var(--font); color: var(--text-primary); }
    .cav-page * { box-sizing: border-box; }
    ...
    /* Layout */
    .cav-layout { display: grid; grid-template-columns: 1fr 300px; gap: 20px; align-items: start; }
    @media(max-width:860px) { .cav-layout { grid-template-columns: 1fr; } }
    ...
    @media(max-width:768px) { .cav-page { padding: 16px; } }
    </style>
        ...
        <div class="cav-page">
            ...
            <div class="page-header">
                <div>
                    ...
                    <div class="crumb">
                        ...
                        <span>›</span>
                        <a href="{{ route('admin.attribute-values.index') }}">Attribute Values</a>
                        <span>›</span>
                        Add Attribute Value
                    </div>
                </div>
            ...
            <form method="POST" action="{{ route('admin.attribute-values.store') }}" class="save-form">
                        ...
                        <div class="section-card">
                            ...
                            <div class="section-card-body">
                                ...
                                <div class="field-group">
                                    ...
                                    <input type="text" name="value" class="field-input" required placeholder="e.g. Red, XL, Cotton">
                                </div>

                                <div class="field-group">
                                    <label class="field-label">Sort Order</label>
                                    <input type="number" name="sort_order" class="field-input" value="0" style="max-width:120px">
                                    <div class="field-hint">Lower numbers appear first in the list.</div>
                                </div>
                            ...
                            <div class="section-card-body" style="padding:16px 20px">
                                <div style="font-size:12.5px;color:var(--text-secondary);line-height:1.8">
                                    <div style="display:flex;align-items:center;gap:8px;margin-bottom:6px">
                                        <span style="background:var(--accent-light);color:var(--accent);font-size:11px;font-weight:600;padding:2px 8px;border-radius:6px">Colour</span>
                                        <span style="color:var(--text-hint)">→</span>
                                        <span>Red, Blue, Green</span>
                                    </div>
                                    <div style="display:flex;align-items:center;gap:8px;margin-bottom:6px">
                                        <span style="background:var(--accent-light);color:var(--accent);font-size:11px;font-weight:600;padding:2px 8px;border-radius:6px">Size</span>
                                        <span style="color:var(--text-hint)">→</span>
                                        <span>XS, S, M, L, XL</span>
                                    </div>
                                    <div style="display:flex;align-items:center;gap:8px">
                                        <span style="background:var(--accent-light);color:var(--accent);font-size:11px;font-weight:600;padding:2px 8px;border-radius:6px">Material</span>
                                        <span style="color:var(--text-hint)">→</span>
                ...
                <div class="action-bar">
                    <a href="{{ route('admin.attribute-values.index') }}" class="btn-secondary-dash">
                        Cancel
                    </a>
