                    ...
                    <form method="POST" action="{{ route('admin.home-deal-banners.update', $item->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="field-group">
                            ...
                            <img src="{{ asset('storage/'.$item->image) }}" 
                                 class="current-image" alt="Current Banner">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="field-group">
                                    <label class="field-label">Offer Text</label>
                                    <input type="text" name="offer_text" 
                                           value="{{ old('offer_text', $item->offer_text) }}" 
                                           class="field-input">
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="field-group">
                                    ...
                                    <input type="text" name="highlight_text" 
                                           value="{{ old('highlight_text', $item->highlight_text) }}" 
                                           class="field-input">
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="action-bar">
                            <a href="{{ route('admin.home-deal-banners.index') }}" class="btn-secondary-dash">
                                Cancel
                            </a>
