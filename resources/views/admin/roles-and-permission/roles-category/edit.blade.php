...
<div class="main-section">
    ...
    .sp-info-row { display: flex; justify-content: space-between; align-items: center; padding: 8px 0; border-bottom: 1px solid var(--sp-bg); font-size: 13px; }
    ...
    .sp-info-value { font-weight: 600; color: var(--sp-text-primary); }
    ...
    <div class="app-content content container-fluid">
        <div class="sp-page">
            <div class="sp-page-header">
                <div>
                    <h1 class="sp-page-title">Edit Role Category</h1>
                    <div class="sp-crumb">
                        <a href="#">Dashboard</a>
            ...
            <form>
                <div class="sp-create-layout">
                        ...
                        <div class="sp-card">
                            ...
                            <div class="sp-card-body">
                                <div class="sp-field">
                                    ...
                                    <input type="text" class="sp-input" value="Super Admin" required>
                                </div>
                                <div class="sp-field">
                                    <label class="sp-label">Description</label>
                                    <textarea class="sp-textarea">Complete access to all system modules and settings. Can manage everything.</textarea>
                                </div>

                                <!-- Record Info - Moved here -->
                                <div class="sp-card" style="margin-top:24px; margin-bottom:0;">
                                    <div class="sp-card-header"><h5>Record Info</h5></div>
                                    <div class="sp-card-body-sm">
                                        <div class="sp-info-row">
                                            <span class="sp-info-label">Category ID</span>
                                            <span class="sp-info-value" style="font-family:'SF Mono',monospace;font-size:12px;color:var(--sp-accent)">#1</span>
                                        </div>
                                        <div class="sp-info-row">
                                        ...
                                        <div class="sp-info-row">
                                            <span class="sp-info-label">Permissions</span>
                                            <span class="sp-info-value">28</span>
                                        </div>
                                        <div class="sp-info-row">
                                            <span class="sp-info-label">Created</span>
                                            <span class="sp-info-value">12 Mar 2026</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div>
                        ...
                        <div class="sp-card">
                            <div class="sp-card-header"><h5>Quick Links</h5></div>
                            <div class="sp-card-body-sm" style="display:flex;flex-direction:column;gap:8px">
                                <a href="#" style="display:inline-flex;align-items:center;gap:8px;font-size:13px;color:var(--sp-accent);text-decoration:none;font-weight:560">
                                    <i class="fa fa-shield" style="width:14px;text-align:center"></i>
                                    Manage Permissions
                                </a>
                                <a href="#" style="display:inline-flex;align-items:center;gap:8px;font-size:13px;color:var(--sp-accent);text-decoration:none;font-weight:560">
                                    <i class="fa fa-users" style="width:14px;text-align:center"></i>
                                    View Team Members
                                </a>
                            </div>
                        </div>
