...
<div class="main-section">
    ...
    .inq-tag{display:inline-flex;align-items:center;padding:3px 10px;border-radius:6px;font-size:12px;font-weight:600;background:var(--green-bg);color:var(--green);border:1px solid rgba(0,122,94,.15);}
        ...
        <div class="list-page">
            ...
            <div class="list-page-header">
                ...
                <div style="display:flex;gap:8px;flex-wrap:wrap;align-items:center;">
                    <a href="{{ route('admin.coupon-enquiries.export') }}" class="btn-green">
                    ...
                    <table class="data-table">
                        <thead>
                            <tr>
                                ...
                                <th style="width:140px">WhatsApp Optin</th>
                        ...
                        <tbody>
                            ...
                            @forelse($enquiries as $key => $item)
                                ...
                                <tr id="row{{ $item->id }}">
                                    ...
                                    <td><span class="id-chip">{{ $enquiries->firstItem() + $key }}</span></td>
                                    ...
                                    <td>
                                        @if($item->whatsapp_optin)
                                            <span class="inq-tag">Yes</span>
                                        @else
                                            <span style="color:var(--text-hint);font-size:12.5px">No</span>
                                        @endif
                                    </td>
                                ...
                                <tr>
                                    <td colspan="7">
                                        <div class="empty-state">
                                            <div class="empty-icon-wrap"><i class="fa fa-tags"></i></div>
                                            <h6>No Coupon Enquiries Found</h6>
                                            <p>Popup form submissions will appear here.</p>
                                        </div>
                                    </td>
                                </tr>
...
function deleteEnquiry(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "{{ url('admin/coupon-enquiries') }}/" + id,
                type: "DELETE",
...
function bulkDelete() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "{{ route('admin.coupon-enquiries.bulk-delete') }}",
                type: "DELETE",
