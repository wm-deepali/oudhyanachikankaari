...
<div class="main-section">
    ...
    /* Template sub-panel */
    .sp-sub-panel { display: none; }
    .sp-sub-panel.active { display: block; }
        ...
        <div class="sp-page">
            ...
            <div class="sp-page-header">
                ...
                <div style="display:flex;gap:8px;flex-wrap:wrap">
                    ...
                    <button class="sp-btn sp-btn-primary" onclick="saveTemplate()">
            ...
            <div class="sp-channel-panel active" id="panel-sms">
                <div class="sp-tpl-layout">
                    ...
                    <div class="sp-sidenav">
                        ...
                        <div class="sp-sidenav-item active" onclick="switchSmsTemplate('otp',this)"><i class="fa fa-key"></i>OTP / Verification<span class="sp-sidenav-badge active-badge">On</span></div>
                        <div class="sp-sidenav-item" onclick="switchSmsTemplate('order-placed',this)"><i class="fa fa-shopping-bag"></i>Order Placed<span class="sp-sidenav-badge active-badge">On</span></div>
                        <div class="sp-sidenav-item" onclick="switchSmsTemplate('order-confirmed',this)"><i class="fa fa-check-circle"></i>Order Confirmed<span class="sp-sidenav-badge active-badge">On</span></div>
                        <div class="sp-sidenav-item" onclick="switchSmsTemplate('order-shipped',this)"><i class="fa fa-truck"></i>Order Shipped<span class="sp-sidenav-badge active-badge">On</span></div>
                        <div class="sp-sidenav-item" onclick="switchSmsTemplate('order-delivered',this)"><i class="fa fa-box-open"></i>Order Delivered<span class="sp-sidenav-badge active-badge">On</span></div>
                        <div class="sp-sidenav-item" onclick="switchSmsTemplate('order-cancelled',this)"><i class="fa fa-times-circle"></i>Order Cancelled<span class="sp-sidenav-badge draft-badge">Draft</span></div>
                        <div class="sp-sidenav-item" onclick="switchSmsTemplate('payment-success',this)"><i class="fa fa-credit-card"></i>Payment Received<span class="sp-sidenav-badge active-badge">On</span></div>
                        <div class="sp-sidenav-item" onclick="switchSmsTemplate('payment-failed',this)"><i class="fa fa-exclamation-circle"></i>Payment Failed<span class="sp-sidenav-badge off-badge">Off</span></div>
                        <div class="sp-sidenav-item" onclick="switchSmsTemplate('refund',this)"><i class="fa fa-undo"></i>Refund Initiated<span class="sp-sidenav-badge active-badge">On</span></div>
                        <div class="sp-sidenav-item" onclick="switchSmsTemplate('return',this)"><i class="fa fa-reply"></i>Return Approved<span class="sp-sidenav-badge draft-badge">Draft</span></div>
                        <div class="sp-sidenav-item" onclick="switchSmsTemplate('coupon',this)"><i class="fa fa-tag"></i>Coupon / Offer<span class="sp-sidenav-badge off-badge">Off</span></div>
                        <div class="sp-sidenav-item" onclick="switchSmsTemplate('abandoned-cart',this)"><i class="fa fa-shopping-cart"></i>Abandoned Cart<span class="sp-sidenav-badge off-badge">Off</span></div>
                    </div>

                    <!-- Right panel — SMS OTP (default active) -->
                    <div>
                        <div class="sp-panel" id="sms-otp">
                            <div class="sp-panel-header">
                                <div>
                                    <p class="sp-panel-title"><i class="fa fa-key" style="margin-right:7px;color:var(--navy)"></i>OTP / Verification Template</p>
                                    <p class="sp-panel-desc">Sent when a customer requests a one-time password for login, registration, or checkout verification.</p>
                                </div>
                            ...
                            <div class="sp-panel-body">
                                ...
                                <div class="sp-status-bar">
                                    <div>
                                        <div class="sp-status-bar-text"><i class="fa fa-check-circle" style="margin-right:6px"></i>Template is active</div>
                                        <div class="sp-status-bar-sub">OTP SMS will be sent on every verification trigger</div>
                                    </div>
                                ...
                                <div class="sp-grid-2" style="margin-bottom:20px">
                                    <div class="sp-field" style="margin:0">
                                        <label class="sp-label">SMS Provider <span class="sp-req">*</span></label>
                                        ...
                                        <div class="sp-help">Connected gateway for sending this template</div>
                                    </div>
                                    <div class="sp-field" style="margin:0">
                                        <label class="sp-label">Sender ID / From <span class="sp-req">*</span></label>
                                        <input type="text" class="sp-input" value="OUDHYA" placeholder="e.g. OUDHYA" oninput="updateSmsPreview()">
                                        <div class="sp-help">6-char DLT approved sender ID</div>
                                    </div>
                                </div>

                                <div class="sp-grid-2" style="margin-bottom:20px">
                                    <div class="sp-field" style="margin:0">
                                        <label class="sp-label">DLT Template ID <span class="sp-req">*</span></label>
                                        <input type="text" class="sp-input" value="1107173080000065382" placeholder="18-digit DLT ID">
                                        <div class="sp-help">Registered on TRAI DLT portal — mandatory for India</div>
                                    </div>
                                    <div class="sp-field" style="margin:0">
                                ...
                                <div class="sp-field">
                                    ...
                                    <div class="sp-callout info">
                                        ...
                                        <span>Use the variable chips below to insert placeholders. The exact variable text must match your DLT-registered template. Variables are highlighted when sent.</span>
                                    </div>
                                    <div class="sp-editor-wrap">
                                        ...
                                        <textarea class="sp-editor-area" id="sms-otp-body" oninput="updateSmsPreview()">Your OTP for {store_name} is {otp}. Valid for {otp_expiry} minutes. Do not share with anyone. - {brand_name}</textarea>
                                    </div>
                                    <div style="display:flex;justify-content:space-between;margin-top:5px">
                                        <div class="sp-help" id="sms-otp-len">Characters: 115 · Messages: 1 (160 char limit)</div>
                                        <div class="sp-help">Unicode: No</div>
                                    </div>
                                </div>

                                <!-- Variable chips -->
                                <div class="sp-var-section" style="margin-bottom:20px">
                                    <div class="sp-var-title"><i class="fa fa-code"></i> Available Variables — click to insert at cursor</div>
                                    <div class="sp-var-chips">
                                        <span class="sp-var-chip" onclick="insertVar('sms-otp-body','{otp}')"><i class="fa fa-hashtag"></i>{otp}</span>
                                        <span class="sp-var-chip" onclick="insertVar('sms-otp-body','{otp_expiry}')"><i class="fa fa-clock"></i>{otp_expiry}</span>
                                        <span class="sp-var-chip" onclick="insertVar('sms-otp-body','{customer_name}')"><i class="fa fa-user"></i>{customer_name}</span>
                                        <span class="sp-var-chip" onclick="insertVar('sms-otp-body','{store_name}')"><i class="fa fa-store"></i>{store_name}</span>
                                        <span class="sp-var-chip" onclick="insertVar('sms-otp-body','{brand_name}')"><i class="fa fa-tag"></i>{brand_name}</span>
                                        <span class="sp-var-chip" onclick="insertVar('sms-otp-body','{website_url}')"><i class="fa fa-globe"></i>{website_url}</span>
                                    </div>
                                </div>
                                ...
                                <div class="sp-field" style="margin:0">
                                    ...
                                    <div class="sp-preview-wrap">
                                        ...
                                        <div class="sp-preview-body">
                                            <div class="sp-sms-sender">OUDHYA</div>
                                            <div class="sp-sms-bubble" id="sms-preview-bubble">
                                                Your OTP for <strong>Oudhyana Store</strong> is <strong>847291</strong>. Valid for <strong>10</strong> minutes. Do not share with anyone. - Oudhyana
                                            </div>
                                            <div class="sp-sms-char-count">
                                                <span>115 chars</span>
                                                <span>1 SMS part</span>
                                                <span style="color:var(--green)">✓ Within limit</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="sp-grid-3">
                                    ...
                                    <div class="sp-field" style="margin:0">
                                        ...
                                        <input type="number" class="sp-input" value="10" min="1" max="60">
                                    </div>
                                    <div class="sp-field" style="margin:0">
                                        <label class="sp-label">Max Retry Attempts</label>
                                        <input type="number" class="sp-input" value="3" min="1" max="10">
                                    </div>
                                </div>
                        ...
                        <!-- Order Placed SMS -->
                        <div class="sp-panel" id="sms-order-placed" style="display:none">
                            <div class="sp-panel-header">
                                <div>
                                    <p class="sp-panel-title"><i class="fa fa-shopping-bag" style="margin-right:7px;color:var(--navy)"></i>Order Placed Template</p>
                                    <p class="sp-panel-desc">Sent immediately when a customer successfully places an order.</p>
                                </div>
                                <span style="font-size:11px;font-weight:700;padding:3px 10px;border-radius:20px;background:var(--green-bg);color:var(--green);border:1px solid var(--green-border)"><i class="fa fa-circle" style="font-size:7px;margin-right:4px"></i>Active</span>
                            </div>
                            <div class="sp-panel-body">
                                <div class="sp-status-bar">
                                    <div><div class="sp-status-bar-text"><i class="fa fa-check-circle" style="margin-right:6px"></i>Template is active</div><div class="sp-status-bar-sub">SMS sent on every new order</div></div>
                                    <label class="sp-switch"><input type="checkbox" checked onchange="toggleStatus(this)"><span class="sp-switch-track"></span></label>
                                </div>
                                <div class="sp-grid-2" style="margin-bottom:20px">
                                    <div class="sp-field" style="margin:0"><label class="sp-label">SMS Provider <span class="sp-req">*</span></label><select class="sp-select"><option>MSG91</option><option>Twilio</option></select></div>
                                    <div class="sp-field" style="margin:0"><label class="sp-label">DLT Template ID <span class="sp-req">*</span></label><input type="text" class="sp-input" value="1107173080000065391"></div>
                                </div>
                                <div class="sp-field">
                                    <label class="sp-label">Template Body <span class="sp-req">*</span><span class="sp-label-badge sms-badge">SMS</span></label>
                                    <div class="sp-editor-wrap">
                                        <textarea class="sp-editor-area">Hi {customer_name}, your order #{order_id} worth {order_amount} has been placed successfully! Track: {tracking_url} - {brand_name}</textarea>
                                    </div>
                                </div>
                                <div class="sp-var-section" style="margin-bottom:20px">
                                    <div class="sp-var-title"><i class="fa fa-code"></i> Available Variables</div>
                                    <div class="sp-var-chips">
                                        <span class="sp-var-chip">{customer_name}</span>
                                        <span class="sp-var-chip">{order_id}</span>
                                        <span class="sp-var-chip">{order_amount}</span>
                                        <span class="sp-var-chip">{order_date}</span>
                                        <span class="sp-var-chip">{payment_method}</span>
                                        <span class="sp-var-chip">{tracking_url}</span>
                                        <span class="sp-var-chip">{store_name}</span>
                                        <span class="sp-var-chip">{brand_name}</span>
                                    </div>
                                </div>
                                <div class="sp-preview-wrap">
                                    <div class="sp-preview-header"><span class="sp-preview-label"><i class="fa fa-mobile-alt"></i>SMS Preview</span></div>
                                    <div class="sp-preview-body"><div class="sp-sms-bubble">Hi <strong>Rahul</strong>, your order <strong>#ORD-1089</strong> worth <strong>₹3,450</strong> has been placed successfully! Track: oudhyana.com/track/1089 - Oudhyana</div></div>
                                </div>
                            </div>
                        </div>

                        <!-- Generic panels for other SMS templates -->
                        <div class="sp-panel" id="sms-order-confirmed" style="display:none"><div class="sp-panel-header"><div><p class="sp-panel-title"><i class="fa fa-check-circle" style="margin-right:7px;color:var(--navy)"></i>Order Confirmed Template</p><p class="sp-panel-desc">Sent when payment is verified and order is confirmed.</p></div></div><div class="sp-panel-body"><div class="sp-callout success"><i class="fa fa-check-circle"></i><span>This template shares the same variable set as Order Placed. Configure the message body to reflect confirmation context.</span></div><div class="sp-field"><label class="sp-label">Template Body <span class="sp-req">*</span></label><div class="sp-editor-wrap"><textarea class="sp-editor-area">Hi {customer_name}, great news! Your order #{order_id} is confirmed. Payment of {order_amount} received via {payment_method}. Expected delivery: {expected_delivery}. - {brand_name}</textarea></div></div><div class="sp-var-section"><div class="sp-var-title"><i class="fa fa-code"></i> Variables</div><div class="sp-var-chips"><span class="sp-var-chip">{customer_name}</span><span class="sp-var-chip">{order_id}</span><span class="sp-var-chip">{order_amount}</span><span class="sp-var-chip">{payment_method}</span><span class="sp-var-chip">{expected_delivery}</span><span class="sp-var-chip">{brand_name}</span></div></div></div></div>

                        <div class="sp-panel" id="sms-order-shipped" style="display:none"><div class="sp-panel-header"><div><p class="sp-panel-title"><i class="fa fa-truck" style="margin-right:7px;color:var(--navy)"></i>Order Shipped Template</p><p class="sp-panel-desc">Sent when the order is dispatched from warehouse.</p></div></div><div class="sp-panel-body"><div class="sp-field"><label class="sp-label">Template Body <span class="sp-req">*</span></label><div class="sp-editor-wrap"><textarea class="sp-editor-area">Your order #{order_id} has been shipped via {courier_name}! Track with AWB: {awb_number} at {tracking_url}. Expected by {expected_delivery}. - {brand_name}</textarea></div></div><div class="sp-var-section"><div class="sp-var-title"><i class="fa fa-code"></i> Variables</div><div class="sp-var-chips"><span class="sp-var-chip">{order_id}</span><span class="sp-var-chip">{courier_name}</span><span class="sp-var-chip">{awb_number}</span><span class="sp-var-chip">{tracking_url}</span><span class="sp-var-chip">{expected_delivery}</span><span class="sp-var-chip">{brand_name}</span></div></div></div></div>

                        <div class="sp-panel" id="sms-order-delivered" style="display:none"><div class="sp-panel-header"><div><p class="sp-panel-title"><i class="fa fa-box-open" style="margin-right:7px;color:var(--navy)"></i>Order Delivered Template</p></div></div><div class="sp-panel-body"><div class="sp-field"><label class="sp-label">Template Body <span class="sp-req">*</span></label><div class="sp-editor-wrap"><textarea class="sp-editor-area">Hi {customer_name}, your order #{order_id} has been delivered! We hope you love it. Rate your experience: {review_url} - {brand_name}</textarea></div></div><div class="sp-var-section"><div class="sp-var-title"><i class="fa fa-code"></i> Variables</div><div class="sp-var-chips"><span class="sp-var-chip">{customer_name}</span><span class="sp-var-chip">{order_id}</span><span class="sp-var-chip">{review_url}</span><span class="sp-var-chip">{brand_name}</span></div></div></div></div>

                        <div class="sp-panel" id="sms-order-cancelled" style="display:none"><div class="sp-panel-header"><div><p class="sp-panel-title"><i class="fa fa-times-circle" style="margin-right:7px;color:var(--red)"></i>Order Cancelled Template</p></div><span style="font-size:11px;font-weight:700;padding:3px 10px;border-radius:20px;background:var(--amber-bg);color:var(--amber);border:1px solid var(--amber-border)">Draft</span></div><div class="sp-panel-body"><div class="sp-callout warn"><i class="fa fa-exclamation-triangle"></i><span>This template is in Draft status. It will not be sent until activated.</span></div><div class="sp-field"><label class="sp-label">Template Body <span class="sp-req">*</span></label><div class="sp-editor-wrap"><textarea class="sp-editor-area">Hi {customer_name}, your order #{order_id} has been cancelled. Refund of {refund_amount} will be processed in {refund_days} business days. - {brand_name}</textarea></div></div><div class="sp-var-section"><div class="sp-var-title"><i class="fa fa-code"></i> Variables</div><div class="sp-var-chips"><span class="sp-var-chip">{customer_name}</span><span class="sp-var-chip">{order_id}</span><span class="sp-var-chip">{cancel_reason}</span><span class="sp-var-chip">{refund_amount}</span><span class="sp-var-chip">{refund_days}</span><span class="sp-var-chip">{brand_name}</span></div></div></div></div>

                        <div class="sp-panel" id="sms-payment-success" style="display:none"><div class="sp-panel-header"><div><p class="sp-panel-title"><i class="fa fa-credit-card" style="margin-right:7px;color:var(--green)"></i>Payment Received Template</p></div></div><div class="sp-panel-body"><div class="sp-field"><label class="sp-label">Template Body <span class="sp-req">*</span></label><div class="sp-editor-wrap"><textarea class="sp-editor-area">Payment of {payment_amount} received for order #{order_id} via {payment_method}. Transaction ID: {transaction_id}. Thank you! - {brand_name}</textarea></div></div><div class="sp-var-section"><div class="sp-var-title"><i class="fa fa-code"></i> Variables</div><div class="sp-var-chips"><span class="sp-var-chip">{payment_amount}</span><span class="sp-var-chip">{order_id}</span><span class="sp-var-chip">{payment_method}</span><span class="sp-var-chip">{transaction_id}</span><span class="sp-var-chip">{brand_name}</span></div></div></div></div>

                        <div class="sp-panel" id="sms-payment-failed" style="display:none"><div class="sp-panel-header"><div><p class="sp-panel-title"><i class="fa fa-exclamation-circle" style="margin-right:7px;color:var(--red)"></i>Payment Failed Template</p></div><span style="font-size:11px;font-weight:700;padding:3px 10px;border-radius:20px;background:var(--bg);color:var(--text-hint);border:1px solid var(--border)">Off</span></div><div class="sp-panel-body"><div class="sp-status-bar inactive"><div><div class="sp-status-bar-text">Template is disabled</div><div class="sp-status-bar-sub">Enable to send payment failure alerts</div></div><label class="sp-switch"><input type="checkbox" onchange="toggleStatus(this)"><span class="sp-switch-track"></span></label></div><div class="sp-field"><label class="sp-label">Template Body <span class="sp-req">*</span></label><div class="sp-editor-wrap"><textarea class="sp-editor-area">Hi {customer_name}, payment of {payment_amount} for order #{order_id} failed. Please retry at {retry_url}. Need help? Call {support_number}. - {brand_name}</textarea></div></div><div class="sp-var-section"><div class="sp-var-title"><i class="fa fa-code"></i> Variables</div><div class="sp-var-chips"><span class="sp-var-chip">{customer_name}</span><span class="sp-var-chip">{payment_amount}</span><span class="sp-var-chip">{order_id}</span><span class="sp-var-chip">{retry_url}</span><span class="sp-var-chip">{support_number}</span><span class="sp-var-chip">{brand_name}</span></div></div></div></div>

                        <div class="sp-panel" id="sms-refund" style="display:none"><div class="sp-panel-header"><div><p class="sp-panel-title"><i class="fa fa-undo" style="margin-right:7px;color:var(--navy)"></i>Refund Initiated Template</p></div></div><div class="sp-panel-body"><div class="sp-field"><label class="sp-label">Template Body <span class="sp-req">*</span></label><div class="sp-editor-wrap"><textarea class="sp-editor-area">Hi {customer_name}, refund of {refund_amount} for order #{order_id} has been initiated. It will reflect in {refund_days} business days to your {refund_method}. - {brand_name}</textarea></div></div><div class="sp-var-section"><div class="sp-var-title"><i class="fa fa-code"></i> Variables</div><div class="sp-var-chips"><span class="sp-var-chip">{customer_name}</span><span class="sp-var-chip">{refund_amount}</span><span class="sp-var-chip">{order_id}</span><span class="sp-var-chip">{refund_days}</span><span class="sp-var-chip">{refund_method}</span><span class="sp-var-chip">{brand_name}</span></div></div></div></div>

                        <div class="sp-panel" id="sms-return" style="display:none"><div class="sp-panel-header"><div><p class="sp-panel-title"><i class="fa fa-reply" style="margin-right:7px;color:var(--navy)"></i>Return Approved Template</p></div><span style="font-size:11px;font-weight:700;padding:3px 10px;border-radius:20px;background:var(--amber-bg);color:var(--amber);border:1px solid var(--amber-border)">Draft</span></div><div class="sp-panel-body"><div class="sp-field"><label class="sp-label">Template Body <span class="sp-req">*</span></label><div class="sp-editor-wrap"><textarea class="sp-editor-area">Your return request #{return_id} for order #{order_id} is approved. Pickup scheduled on {pickup_date}. Keep items ready. Refund: {refund_amount}. - {brand_name}</textarea></div></div><div class="sp-var-section"><div class="sp-var-title"><i class="fa fa-code"></i> Variables</div><div class="sp-var-chips"><span class="sp-var-chip">{return_id}</span><span class="sp-var-chip">{order_id}</span><span class="sp-var-chip">{pickup_date}</span><span class="sp-var-chip">{refund_amount}</span><span class="sp-var-chip">{brand_name}</span></div></div></div></div>

                        <div class="sp-panel" id="sms-coupon" style="display:none"><div class="sp-panel-header"><div><p class="sp-panel-title"><i class="fa fa-tag" style="margin-right:7px;color:var(--navy)"></i>Coupon / Offer Template</p></div><span style="font-size:11px;font-weight:700;padding:3px 10px;border-radius:20px;background:var(--bg);color:var(--text-hint);border:1px solid var(--border)">Off</span></div><div class="sp-panel-body"><div class="sp-callout warn"><i class="fa fa-exclamation-triangle"></i><span>Promotional SMSes require DND scrubbing and are governed by TRAI regulations. Ensure proper consent before enabling.</span></div><div class="sp-field"><label class="sp-label">Template Body <span class="sp-req">*</span></label><div class="sp-editor-wrap"><textarea class="sp-editor-area">Exclusive for you! Use code {coupon_code} and get {discount_value} off on your next order at {store_url}. Valid till {expiry_date}. Shop now: {shop_url} - {brand_name}</textarea></div></div><div class="sp-var-section"><div class="sp-var-title"><i class="fa fa-code"></i> Variables</div><div class="sp-var-chips"><span class="sp-var-chip">{coupon_code}</span><span class="sp-var-chip">{discount_value}</span><span class="sp-var-chip">{expiry_date}</span><span class="sp-var-chip">{customer_name}</span><span class="sp-var-chip">{store_url}</span><span class="sp-var-chip">{shop_url}</span><span class="sp-var-chip">{brand_name}</span></div></div></div></div>

                        <div class="sp-panel" id="sms-abandoned-cart" style="display:none"><div class="sp-panel-header"><div><p class="sp-panel-title"><i class="fa fa-shopping-cart" style="margin-right:7px;color:var(--navy)"></i>Abandoned Cart Template</p></div><span style="font-size:11px;font-weight:700;padding:3px 10px;border-radius:20px;background:var(--bg);color:var(--text-hint);border:1px solid var(--border)">Off</span></div><div class="sp-panel-body"><div class="sp-field"><label class="sp-label">Delay After Abandonment</label><select class="sp-select" style="width:200px"><option>30 minutes</option><option selected>1 hour</option><option>2 hours</option><option>6 hours</option><option>24 hours</option></select><div class="sp-help">Wait time before sending the recovery SMS</div></div><div class="sp-field"><label class="sp-label">Template Body <span class="sp-req">*</span></label><div class="sp-editor-wrap"><textarea class="sp-editor-area">Hi {customer_name}, you left {item_count} item(s) in your cart! Complete your order at {cart_url} and use code {coupon_code} for {discount}% off. - {brand_name}</textarea></div></div><div class="sp-var-section"><div class="sp-var-title"><i class="fa fa-code"></i> Variables</div><div class="sp-var-chips"><span class="sp-var-chip">{customer_name}</span><span class="sp-var-chip">{item_count}</span><span class="sp-var-chip">{cart_url}</span><span class="sp-var-chip">{coupon_code}</span><span class="sp-var-chip">{discount}</span><span class="sp-var-chip">{brand_name}</span></div></div></div></div>
                    ...
                    <div>
                        ...
                        <div class="sp-panel" id="email-welcome">
                            ...
                            <div class="sp-panel-body">
                                ...
                                <div class="sp-grid-2" style="margin-bottom:20px">
                                    <div class="sp-field" style="margin:0">
                                        <label class="sp-label">From Name <span class="sp-req">*</span></label>
                                        <input type="text" class="sp-input" value="Oudhyana Chikankaari">
                                    </div>
                                    <div class="sp-field" style="margin:0">
                                        <label class="sp-label">From Email <span class="sp-req">*</span></label>
                                        <input type="email" class="sp-input" value="noreply@oudhyana.com">
                                    </div>
                                </div>
                                ...
                                <div class="sp-grid-2" style="margin-bottom:20px">
                                    <div class="sp-field" style="margin:0">
                                        ...
                                        <input type="email" class="sp-input" value="support@oudhyana.com">
                                    </div>
                                    <div class="sp-field" style="margin:0">
                                        <label class="sp-label">CC (optional)</label>
                                        <input type="email" class="sp-input" placeholder="e.g. sales@oudhyana.com">
                                    </div>
                                </div>
...
&lt;p&gt;Warm regards,&lt;br&gt;Team {brand_name}&lt;/p&gt;</textarea>
                                ...
                                <div class="sp-var-section" style="margin-bottom:20px">
                                    ...
                                    <div class="sp-var-chips">
                                        <span class="sp-var-chip">{customer_name}</span>
                                        <span class="sp-var-chip">{customer_email}</span>
                                        <span class="sp-var-chip">{store_name}</span>
                                        <span class="sp-var-chip">{brand_name}</span>
                                        <span class="sp-var-chip">{shop_url}</span>
                                        <span class="sp-var-chip">{support_number}</span>
                                        <span class="sp-var-chip">{login_url}</span>
                                        <span class="sp-var-chip">{logo_url}</span>
                                ...
                                <div class="sp-grid-2">
                                    <div class="sp-field" style="margin:0">
                                        <label class="sp-label">Email Service Provider</label>
                                        <select class="sp-select"><option selected>SMTP (Custom)</option><option>SendGrid</option><option>Mailgun</option><option>Amazon SES</option></select>
                                    </div>
                                    <div class="sp-field" style="margin:0">
                                        <label class="sp-label">Email Priority</label>
                                        <select class="sp-select"><option>High</option><option selected>Normal</option><option>Low</option></select>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            ══════════════════════════════════════ -->
            <div class="sp-channel-panel" id="panel-whatsapp">
                <div class="sp-tpl-layout">
                    <div class="sp-sidenav">
                        <div class="sp-sidenav-header"><div class="sp-sidenav-label">WhatsApp Template Events</div></div>
                        <div class="sp-sidenav-item active" onclick="switchWaTemplate('otp',this)"><i class="fa fa-key"></i>OTP / Verification<span class="sp-sidenav-badge active-badge">On</span></div>
                        <div class="sp-sidenav-item" onclick="switchWaTemplate('order-placed',this)"><i class="fa fa-shopping-bag"></i>Order Confirmation<span class="sp-sidenav-badge active-badge">On</span></div>
                        <div class="sp-sidenav-item" onclick="switchWaTemplate('order-shipped',this)"><i class="fa fa-truck"></i>Order Shipped<span class="sp-sidenav-badge active-badge">On</span></div>
                        <div class="sp-sidenav-item" onclick="switchWaTemplate('order-delivered',this)"><i class="fa fa-box-open"></i>Order Delivered<span class="sp-sidenav-badge active-badge">On</span></div>
                        <div class="sp-sidenav-item" onclick="switchWaTemplate('payment-success',this)"><i class="fa fa-credit-card"></i>Payment Received<span class="sp-sidenav-badge draft-badge">Draft</span></div>
                        <div class="sp-sidenav-item" onclick="switchWaTemplate('abandoned-cart',this)"><i class="fa fa-shopping-cart"></i>Abandoned Cart<span class="sp-sidenav-badge off-badge">Off</span></div>
                        <div class="sp-sidenav-item" onclick="switchWaTemplate('refund',this)"><i class="fa fa-undo"></i>Refund Update<span class="sp-sidenav-badge active-badge">On</span></div>
                        <div class="sp-sidenav-item" onclick="switchWaTemplate('coupon',this)"><i class="fa fa-tag"></i>Coupon / Offer<span class="sp-sidenav-badge off-badge">Off</span></div>
                    </div>

                    <div>
                        <!-- WA OTP -->
                        <div class="sp-panel" id="wa-otp">
                            <div class="sp-panel-header">
                                <div>
                                    <p class="sp-panel-title"><i class="fa fa-key" style="margin-right:7px;color:#128c7e"></i>WhatsApp OTP Template</p>
                                    <p class="sp-panel-desc">Meta-approved template for sending OTP verification via WhatsApp Business API.</p>
                                </div>
                                <span style="font-size:11px;font-weight:700;padding:3px 10px;border-radius:20px;background:var(--green-bg);color:var(--green);border:1px solid var(--green-border)"><i class="fa fa-circle" style="font-size:7px;margin-right:4px"></i>Active</span>
                            </div>
                            <div class="sp-panel-body">
                                ...
                                <div class="sp-status-bar">
                                    <div><div class="sp-status-bar-text"><i class="fa fa-check-circle" style="margin-right:6px"></i>Template is active</div><div class="sp-status-bar-sub">WA OTP sent on every verification trigger</div></div>
                                    <label class="sp-switch"><input type="checkbox" checked onchange="toggleStatus(this)"><span class="sp-switch-track"></span></label>
                                </div>

                                <div class="sp-callout info"><i class="fa fa-info-circle"></i><span>WhatsApp templates must be pre-approved by Meta via the WhatsApp Business Manager. Template status will show <strong>Pending / Approved / Rejected</strong>. Only Approved templates can be sent to customers outside 24-hour window.</span></div>

                                <div class="sp-grid-2" style="margin-bottom:20px">
                                    <div class="sp-field" style="margin:0"><label class="sp-label">WA Business Account <span class="sp-req">*</span></label><select class="sp-select"><option>Oudhyana Official (+91-9876543210)</option></select></div>
                                    <div class="sp-field" style="margin:0"><label class="sp-label">Meta Template Name <span class="sp-req">*</span></label><input type="text" class="sp-input" value="oudhyana_otp_v2"><div class="sp-help">Exact name registered in Meta Business Manager</div></div>
                                </div>

                                <div class="sp-grid-3" style="margin-bottom:20px">
                                    <div class="sp-field" style="margin:0"><label class="sp-label">Template ID</label><input type="text" class="sp-input" value="1043821756892014"><div class="sp-help">From Meta WABA</div></div>
                                    <div class="sp-field" style="margin:0"><label class="sp-label">Language</label><select class="sp-select"><option>en (English)</option><option>hi (Hindi)</option><option>en_US</option></select></div>
                                    <div class="sp-field" style="margin:0"><label class="sp-label">Approval Status</label><div style="height:38px;display:flex;align-items:center"><span style="font-size:12.5px;font-weight:650;padding:4px 12px;border-radius:20px;background:var(--green-bg);color:var(--green);border:1px solid var(--green-border)"><i class="fa fa-check-circle" style="margin-right:5px"></i>Approved</span></div></div>
                                </div>

                                <hr class="sp-divider">

                                <!-- WA Template structure -->
                                <div class="sp-field">
                                    <label class="sp-label">Header <span class="sp-label-badge wa-badge">Optional</span></label>
                                    <select class="sp-select" style="width:160px;margin-bottom:10px">
                                    ...
                                    <input type="text" class="sp-input" value="OTP Verification" placeholder="Header text (max 60 chars)">
                                </div>

                                <div class="sp-field">
                                    <label class="sp-label">Body (Message) <span class="sp-req">*</span><span class="sp-label-badge wa-badge">WhatsApp</span></label>
                                    <div class="sp-editor-wrap">
                                        <textarea class="sp-editor-area" id="wa-otp-body">Your OTP for *{store_name}* is *{otp}*.

This OTP is valid for *{otp_expiry} minutes* only.

_Do not share this OTP with anyone._

Team {brand_name}</textarea>
                                    </div>
                                    <div class="sp-help">Use *text* for bold, _text_ for italic. Supported in WhatsApp.</div>
                                </div>

                                <div class="sp-field">
                                    <label class="sp-label">Footer <span class="sp-label-badge wa-badge">Optional</span></label>
                                    <input type="text" class="sp-input" value="Not you? Ignore this message." placeholder="Short footer text">
                                </div>

                                <div class="sp-field">
                                    <label class="sp-label">Quick Reply / CTA Buttons <span class="sp-label-badge wa-badge">Optional</span></label>
                                    <div style="display:flex;flex-direction:column;gap:8px">
                                        <div style="display:flex;gap:8px;align-items:center">
                                            <select class="sp-select" style="width:130px;flex-shrink:0"><option>Quick Reply</option><option selected>CTA - URL</option><option>CTA - Phone</option></select>
                                            <input type="text" class="sp-input" value="Resend OTP" placeholder="Button label">
                                            <button style="width:32px;height:32px;border-radius:var(--radius-sm);border:1px solid var(--red-border);background:var(--red-bg);color:var(--red);cursor:pointer;flex-shrink:0" onclick=""><i class="fa fa-times"></i></button>
                                        </div>
                                        <button class="sp-btn sp-btn-ghost sp-btn-sm" style="width:fit-content"><i class="fa fa-plus"></i> Add Button</button>
                                    </div>
                                </div>

                                <!-- Variables -->
                                <div class="sp-var-section" style="margin-bottom:20px">
                                    <div class="sp-var-title"><i class="fa fa-code"></i> Variables — {{1}} {{2}} format (auto-mapped)</div>
                                    <div class="sp-var-chips">
                                        <span class="sp-var-chip">{otp}</span>
                                        <span class="sp-var-chip">{otp_expiry}</span>
                                        <span class="sp-var-chip">{store_name}</span>
                                        <span class="sp-var-chip">{brand_name}</span>
                                        <span class="sp-var-chip">{customer_name}</span>
                                    </div>
                                ...
                                <!-- WA Preview -->
                                <div class="sp-field" style="margin:0">
                                    <label class="sp-label"><i class="fa fa-eye" style="margin-right:5px"></i>WhatsApp Preview</label>
                                    <div class="sp-wa-preview">
                                        <div class="sp-wa-bubble">
                                            <div class="sp-wa-bubble-header">OTP Verification</div>
                                            <div class="sp-wa-bubble-body">Your OTP for <strong>Oudhyana Store</strong> is <strong>847291</strong>.<br><br>This OTP is valid for <strong>10 minutes</strong> only.<br><br><em>Do not share this OTP with anyone.</em><br><br>Team Oudhyana</div>
                                            <div class="sp-wa-bubble-footer">Not you? Ignore this message.</div>
                                            <div class="sp-wa-btn">Resend OTP</div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <!-- WA Order placed -->
                        <div class="sp-panel" id="wa-order-placed" style="display:none">
                            <div class="sp-panel-header"><div><p class="sp-panel-title"><i class="fa fa-shopping-bag" style="margin-right:7px;color:#128c7e"></i>WhatsApp Order Confirmation</p><p class="sp-panel-desc">Interactive order confirmation message with tracking CTA.</p></div></div>
                            <div class="sp-panel-body">
                                <div class="sp-grid-2" style="margin-bottom:20px"><div class="sp-field" style="margin:0"><label class="sp-label">Meta Template Name</label><input class="sp-input" type="text" value="oudhyana_order_confirm_v1"></div><div class="sp-field" style="margin:0"><label class="sp-label">Status</label><div style="height:38px;display:flex;align-items:center"><span style="font-size:12.5px;font-weight:650;padding:4px 12px;border-radius:20px;background:var(--green-bg);color:var(--green);border:1px solid var(--green-border)"><i class="fa fa-check-circle" style="margin-right:5px"></i>Approved</span></div></div></div>
                                <div class="sp-field"><label class="sp-label">Body <span class="sp-req">*</span></label><div class="sp-editor-wrap"><textarea class="sp-editor-area">Hi *{customer_name}* 👋

Your order *#{order_id}* worth *{order_amount}* has been placed successfully!
...
Team *{brand_name}*</textarea></div></div>
                                <div class="sp-var-section" style="margin-bottom:20px"><div class="sp-var-title"><i class="fa fa-code"></i>Variables</div><div class="sp-var-chips"><span class="sp-var-chip">{customer_name}</span><span class="sp-var-chip">{order_id}</span><span class="sp-var-chip">{order_amount}</span><span class="sp-var-chip">{order_date}</span><span class="sp-var-chip">{payment_method}</span><span class="sp-var-chip">{expected_delivery}</span><span class="sp-var-chip">{brand_name}</span><span class="sp-var-chip">{order_url}</span></div></div>
                                <div class="sp-wa-preview"><div class="sp-wa-bubble"><div class="sp-wa-bubble-header">Order Confirmed ✅</div><div class="sp-wa-bubble-body">Hi <strong>Rahul</strong> 👋<br><br>Your order <strong>#ORD-1089</strong> worth <strong>₹3,450</strong> placed!<br><br>🗓️ 24 Jun 2026 &nbsp; 💳 UPI &nbsp; 🚚 28 Jun</div><div class="sp-wa-btn">Track Order</div></div></div>
                            </div>
                        </div>

                        <!-- Other WA panels -->
                        <div class="sp-panel" id="wa-order-shipped" style="display:none"><div class="sp-panel-header"><div><p class="sp-panel-title"><i class="fa fa-truck" style="margin-right:7px;color:#128c7e"></i>WhatsApp Order Shipped</p></div></div><div class="sp-panel-body"><div class="sp-field"><label class="sp-label">Body <span class="sp-req">*</span></label><div class="sp-editor-wrap"><textarea class="sp-editor-area">📦 Order #{order_id} shipped via *{courier_name}*!
AWB: *{awb_number}*
Track: {tracking_url}
Expected: *{expected_delivery}*
Team *{brand_name}*</textarea></div></div><div class="sp-var-section"><div class="sp-var-title"><i class="fa fa-code"></i>Variables</div><div class="sp-var-chips"><span class="sp-var-chip">{order_id}</span><span class="sp-var-chip">{courier_name}</span><span class="sp-var-chip">{awb_number}</span><span class="sp-var-chip">{tracking_url}</span><span class="sp-var-chip">{expected_delivery}</span><span class="sp-var-chip">{brand_name}</span></div></div></div></div>
                        <div class="sp-panel" id="wa-order-delivered" style="display:none"><div class="sp-panel-header"><div><p class="sp-panel-title"><i class="fa fa-box-open" style="margin-right:7px;color:#128c7e"></i>WhatsApp Order Delivered</p></div></div><div class="sp-panel-body"><div class="sp-field"><label class="sp-label">Body <span class="sp-req">*</span></label><div class="sp-editor-wrap"><textarea class="sp-editor-area">🎉 Hi *{customer_name}*, your order #{order_id} has been delivered!

We hope you love it. Please leave a review: {review_url}

Team *{brand_name}*</textarea></div></div><div class="sp-var-section"><div class="sp-var-title"><i class="fa fa-code"></i>Variables</div><div class="sp-var-chips"><span class="sp-var-chip">{customer_name}</span><span class="sp-var-chip">{order_id}</span><span class="sp-var-chip">{review_url}</span><span class="sp-var-chip">{brand_name}</span></div></div></div></div>
                        <div class="sp-panel" id="wa-payment-success" style="display:none"><div class="sp-panel-header"><div><p class="sp-panel-title"><i class="fa fa-credit-card" style="margin-right:7px;color:#128c7e"></i>WhatsApp Payment Received</p></div><span style="font-size:11px;font-weight:700;padding:3px 10px;border-radius:20px;background:var(--amber-bg);color:var(--amber);border:1px solid var(--amber-border)">Pending Approval</span></div><div class="sp-panel-body"><div class="sp-callout warn"><i class="fa fa-exclamation-triangle"></i><span>This template is pending Meta approval. You can edit it but it cannot be sent until approved.</span></div><div class="sp-field"><label class="sp-label">Body</label><div class="sp-editor-wrap"><textarea class="sp-editor-area">✅ Payment of *{payment_amount}* received for order #{order_id}. Transaction: {transaction_id}. Team *{brand_name}*</textarea></div></div></div></div>
                        <div class="sp-panel" id="wa-abandoned-cart" style="display:none"><div class="sp-panel-header"><div><p class="sp-panel-title"><i class="fa fa-shopping-cart" style="margin-right:7px;color:#128c7e"></i>WhatsApp Abandoned Cart</p></div><span style="font-size:11px;font-weight:700;padding:3px 10px;border-radius:20px;background:var(--bg);color:var(--text-hint);border:1px solid var(--border)">Off</span></div><div class="sp-panel-body"><div class="sp-field"><label class="sp-label">Delay</label><select class="sp-select" style="width:160px"><option selected>1 hour</option><option>2 hours</option><option>6 hours</option></select></div><div class="sp-field"><label class="sp-label">Body</label><div class="sp-editor-wrap"><textarea class="sp-editor-area">Hey *{customer_name}* 👋 You left {item_count} items in your cart!
Complete your order: {cart_url}
Use *{coupon_code}* for *{discount}%* off ⚡
Team *{brand_name}*</textarea></div></div><div class="sp-var-section"><div class="sp-var-title"><i class="fa fa-code"></i>Variables</div><div class="sp-var-chips"><span class="sp-var-chip">{customer_name}</span><span class="sp-var-chip">{item_count}</span><span class="sp-var-chip">{cart_url}</span><span class="sp-var-chip">{coupon_code}</span><span class="sp-var-chip">{discount}</span></div></div></div></div>
                        <div class="sp-panel" id="wa-refund" style="display:none"><div class="sp-panel-header"><div><p class="sp-panel-title"><i class="fa fa-undo" style="margin-right:7px;color:#128c7e"></i>WhatsApp Refund Update</p></div></div><div class="sp-panel-body"><div class="sp-field"><label class="sp-label">Body</label><div class="sp-editor-wrap"><textarea class="sp-editor-area">Hi *{customer_name}*, refund of *{refund_amount}* for order #{order_id} processed. Reflects in {refund_days} days via {refund_method}. Team *{brand_name}*</textarea></div></div><div class="sp-var-section"><div class="sp-var-title"><i class="fa fa-code"></i>Variables</div><div class="sp-var-chips"><span class="sp-var-chip">{customer_name}</span><span class="sp-var-chip">{refund_amount}</span><span class="sp-var-chip">{order_id}</span><span class="sp-var-chip">{refund_days}</span><span class="sp-var-chip">{refund_method}</span></div></div></div></div>
                        <div class="sp-panel" id="wa-coupon" style="display:none"><div class="sp-panel-header"><div><p class="sp-panel-title"><i class="fa fa-tag" style="margin-right:7px;color:#128c7e"></i>WhatsApp Coupon / Offer</p></div><span style="font-size:11px;font-weight:700;padding:3px 10px;border-radius:20px;background:var(--bg);color:var(--text-hint);border:1px solid var(--border)">Off</span></div><div class="sp-panel-body"><div class="sp-callout warn"><i class="fa fa-exclamation-triangle"></i><span>Marketing messages on WhatsApp require explicit opt-in from the customer. Sending without consent violates WhatsApp policies and may result in account ban.</span></div><div class="sp-field"><label class="sp-label">Body</label><div class="sp-editor-wrap"><textarea class="sp-editor-area">🎁 *Exclusive offer for you, {customer_name}!*
Use *{coupon_code}* and get *{discount_value}* off your next order.
Valid till: {expiry_date}
Shop: {shop_url}
Team *{brand_name}*</textarea></div></div></div></div>
            ...
            <div class="sp-action-bar">
                <div class="sp-action-bar-left">
                    <i class="fa fa-info-circle"></i>
                    Changes save to the active template only. Switch tabs to edit other channels.
                </div>
                <div class="sp-action-bar-right">
                    <button class="sp-btn sp-btn-secondary" onclick="openTestModal()">
                        <i class="fa fa-paper-plane"></i> Send Test
                    </button>
                    <button class="sp-btn sp-btn-secondary">
...
<div class="sp-modal-overlay" id="testModal">
    <div class="sp-modal">
        <div class="sp-modal-header">
            <h5 class="sp-modal-title"><i class="fa fa-paper-plane" style="margin-right:8px;color:var(--navy)"></i>Send Test Message</h5>
            <button class="sp-modal-close" onclick="closeModal()"><i class="fa fa-times"></i></button>
        </div>
        <div class="sp-modal-body">
            <div class="sp-callout info"><i class="fa fa-info-circle"></i><span>Test messages are sent with sample variable values. Actual customer data is not used.</span></div>
            <div class="sp-field">
                <label class="sp-label">Channel</label>
                <select class="sp-select" id="testChannel">
                    <option>SMS</option>
                    <option>Email</option>
            ...
            <div class="sp-field">
                <label class="sp-label">Send To (Phone / Email) <span class="sp-req">*</span></label>
                <input type="text" class="sp-input" placeholder="+91 98765 43210 or test@domain.com">
            </div>
            <div class="sp-field" style="margin:0">
                <label class="sp-label">Sample Customer Name</label>
                <input type="text" class="sp-input" value="Rahul Sharma" placeholder="Used to fill {customer_name}">
            </div>
        </div>
        <div class="sp-modal-footer">
            <button class="sp-btn sp-btn-secondary" onclick="closeModal()">Cancel</button>
            <button class="sp-btn sp-btn-primary" onclick="sendTest()"><i class="fa fa-paper-plane"></i> Send Test</button>
        </div>
    </div>
</div>
...
/* ── SMS template switcher ── */
let activeSmsPanel = 'sms-otp';
function switchSmsTemplate(key, navItem) {
    document.querySelectorAll('#panel-sms .sp-sidenav-item').forEach(i => i.classList.remove('active'));
    navItem.classList.add('active');
    document.getElementById(activeSmsPanel).style.display = 'none';
    activeSmsPanel = 'sms-' + key;
    document.getElementById(activeSmsPanel).style.display = 'block';
}
...
/* ── WA template switcher ── */
let activeWaPanel = 'wa-otp';
function switchWaTemplate(key, navItem) {
    document.querySelectorAll('#panel-whatsapp .sp-sidenav-item').forEach(i => i.classList.remove('active'));
    navItem.classList.add('active');
    document.getElementById(activeWaPanel).style.display = 'none';
    activeWaPanel = 'wa-' + key;
    document.getElementById(activeWaPanel).style.display = 'block';
}
...
function saveTemplate() {
    Swal.fire({ icon:'success', title:'Template Saved!', text:'Changes have been saved successfully.', timer:1800, showConfirmButton:false });
}
...
function sendTest() {
    closeModal();
    Swal.fire({ icon:'success', title:'Test Sent!', text:'Test message dispatched successfully. Check your device.', timer:2000, showConfirmButton:false });
}
</script>