...
<div class="main-section">
    ...
    .page-create { background: var(--bg); padding: 24px 28px; min-height: 100vh; font-family: var(--font); color: var(--text-primary); }
    .page-create * { box-sizing: border-box; }
    ...
    @media(max-width:768px) { .page-create { padding: 16px; } }
    </style>
            ...
            <form method="POST" action="{{ route('admin.pages.store') }}">
                ...
                <div class="create-layout">
                            ...
                            <div class="section-card-body">
                                ...
                                <div class="two-col" style="margin-bottom:16px">
                                    <div class="field-group" style="margin:0">
                                        ...
                                        <input type="text" name="page_name" class="field-input" placeholder="e.g. about-us">
                                        <div class="field-hint">Used in the URL: /page/<strong>slug</strong></div>
                                    </div>
                                    <div class="field-group" style="margin:0">
                                        <label class="field-label">Heading</label>
                                        <input type="text" name="heading" class="field-input" placeholder="e.g. About Us">
                                    </div>
                                </div>

                                <div class="field-group">
                                    <label class="field-label">Page Content</label>
                                    <textarea name="content" id="content" class="field-textarea editor" style="min-height:200px"></textarea>
                                </div>
                        ...
                        <div class="section-card">
                            ...
                            <div class="section-card-body">
                                ...
                                <div class="field-group">
                                    ...
                                    <textarea name="meta_description" class="field-textarea" placeholder="Brief description shown in search results (150–160 chars)"></textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <!-- Help card -->
                        <div class="section-card">
                            <div class="section-card-header"><h5>Examples</h5></div>
                            <div class="section-card-body" style="padding:14px 20px">
                                <div style="font-size:12.5px;color:var(--text-secondary);line-height:1.9">
                                    <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid var(--bg)">
                                        <span style="color:var(--text-hint)">Slug</span>
                                        <span style="font-family:monospace;color:var(--accent);font-size:12px">about-us</span>
                                    </div>
                                    <div style="display:flex;justify-content:space-between;padding:5px 0;border-bottom:1px solid var(--bg)">
                                        <span style="color:var(--text-hint)">Slug</span>
                                        <span style="font-family:monospace;color:var(--accent);font-size:12px">privacy-policy</span>
                                    </div>
                                    <div style="display:flex;justify-content:space-between;padding:5px 0">
                                        <span style="color:var(--text-hint)">Slug</span>
                                        <span style="font-family:monospace;color:var(--accent);font-size:12px">terms-conditions</span>
                                    </div>
                                </div>
                            </div>
                        </div>
