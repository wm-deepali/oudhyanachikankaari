        ...
        <div class="eav-page">
            ...
            <div class="page-header">
                ...
                <div class="av-identity">
                    <div class="av-identity-icon">
                        <i class="fa fa-tag"></i>
                    </div>
                    <div>
                        <div class="av-identity-name">{{ $attributeValue->value }}</div>
                        <div class="av-identity-meta">
                            ...
                            <div class="section-card-body">
                                ...
                                <div class="field-group">
                                    ...
                                    <input type="number" name="sort_order" class="field-input"
                                        value="{{ $attributeValue->sort_order }}" style="max-width:120px">
            ...
            <textarea name="meta_description"
                ...
                <div class="action-bar">
                    ...
                    <button type="submit" class="btn-primary-dash save-btn">
                        <i class="fa fa-save"></i> Update Value
                    </button>
                </div>
