            ...
            <form id="teamForm" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="section-card">
                            ...
                            <div class="section-card-body">
                                ...
                                <div class="field-group">
                                    ...
                                    <input type="text" name="name" class="field-input" value="{{ old('name', $team->name) }}">
                                    @error('name') <div class="field-error">{{ $message }}</div> @enderror
                                </div>

                                <div class="field-group">
                                    <label class="field-label">Designation <span class="req">*</span></label>
                                    <input type="text" name="designation" class="field-input" value="{{ old('designation', $team->designation) }}">
                                ...
                                <div class="field-group">
                                    ...
                                    <textarea name="description" class="field-textarea" rows="5"
                                              placeholder="A short bio shown on the team profile…">{{ old('description', $team->description) }}</textarea>
                                </div>
                            ...
                            <div class="section-card-body">
                                <div class="upload-area" id="uploadArea">
                                    ...
                                    @if($team->image)
                                        <div class="upload-preview" id="uploadPreview">
                                            <img id="previewImg" src="{{ asset('storage/' . $team->image) }}" alt="{{ $team->name }}">
                                ...
                                @if($team->image)
                                    <div class="current-icon-note">
                                        <i class="fa fa-info-circle"></i> Current photo shown above — upload a new file to replace it.
                                    </div>
                                @endif
                            </div>
                        </div>
                ...
                <div class="action-bar">
                    ...
                    <button type="submit" id="saveBtn" class="btn-primary-dash">
                        <i class="fa-solid fa-save"></i> Update Team Member
                    </button>
                </div>
