        ...
        <div class="detail-page">
            ...
            <div class="section-card">
                <div class="section-card-header">
                    <h5>Slider Image Details</h5>
                </div>
                <div class="section-card-body">
                    <form method="POST" action="{{ route('admin.home-brand-section-images.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="field-group">
                            ...
                            <small class="text-muted d-block mt-1">
                                Recommended Size: 2048 × 730 px (Same as other sliders)
                            </small>
                        </div>
                        ...
                        <div class="action-bar">
                            <a href="{{ route('admin.home-brand-section-images.index') }}" class="btn-secondary-dash">
                                Cancel
                            </a>
                            <button type="submit" class="btn-primary-dash">
                                <i class="fa fa-save"></i> Save Slider Image
                            </button>
                        </div>
                    </form>
                </div>
