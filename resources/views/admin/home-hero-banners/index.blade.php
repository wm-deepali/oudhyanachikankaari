    ...
    <div class="app-content content container-fluid">
        <div class="list-page">
            ...
            <div class="list-page-header">
                ...
                <div>
                    <a href="{{ route('admin.home-hero-banners.create') }}" class="btn-primary-dash">
                        <i class="fa fa-plus"></i> Add Hero Banner
                    </a>
                </div>
            </div>
                                    ...
                                    <td>
                                        @if($item->image)
                                            <img src="{{ asset('storage/'.$item->image) }}" 
                                                 class="banner-img" alt="Hero Banner">
                                        @endif
                                    </td>
