...
<div class="main-section">
    ...
    /* Buttons, Filter, Table, etc. styles remain the same as before */
        ...
        <div class="orders-page">
            ...
            <div class="kpi-strip">
                <div class="kpi-tile">
                    ...
                    <div>
                        ...
                        <div class="kpi-tile-value">1,284</div>
                    </div>
                </div>
                <div class="kpi-tile">
                ...
                <div class="kpi-tile">
                    ...
                    <div>
                        ...
                        <div class="kpi-tile-value">963</div>
                    </div>
                </div>
            </div>
            ...
            <div class="orders-card">
                ...
                <div class="status-tabs">
                    ...
                    <a href="#" class="status-tab">New</a>
                    <a href="#" class="status-tab">Processing</a>
                    <a href="#" class="status-tab">Shipped</a>
                    <a href="#" class="status-tab">Delivered</a>
                    ...
                    <form method="GET">
                        <div class="filter-row">
                            <div class="filter-group" style="flex:1">
                                <label>Search</label>
                                <input type="text" class="filter-control filter-control-wide" placeholder="Order ID, customer name or email…">
                            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="display:flex;align-items:center;gap:10px">
                                        <div class="customer-avatar" style="background:#e8f2ff;color:#0069d9">SJ</div>
                                        <div>
                                ...
                                <td><span class="items-chip"><i class="fa fa-cube" style="font-size:10px"></i> 3 items</span></td>
                                <td><span class="amount-cell">₹2,899.00</span></td>
                                <td><span class="pay-pill pay-paid">Paid</span></td>
                                <td><span class="order-pill order-delivered">Delivered</span></td>
                                <td>
                                    <div class="date-cell">10 Jun 2026 <small>02:45 PM</small></div>
                                </td>
                                <td>
                                    <div style="display:flex;gap:5px">
                                        <a href="#" class="action-btn action-btn-view"><i class="fa fa-eye"></i></a>
                                        <a href="#" class="action-btn action-btn-invoice"><i class="fa-solid fa-file-pdf"></i></a>
                                        <a href="#" class="action-btn action-btn-customer"><i class="fa fa-user"></i></a>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td><span class="order-id">#ORD-78491</span></td>
                                <td>
                                    <div style="display:flex;align-items:center;gap:10px">
                                        <div class="customer-avatar" style="background:#fff5cc;color:#916a00">RK</div>
                                        <div>
                                            <div class="customer-name">Rahul Kumar</div>
                                            <div class="customer-email">rahul.k@email.com</div>
                                        </div>
                                    </div>
                                </td>
                                <td><span class="items-chip"><i class="fa fa-cube" style="font-size:10px"></i> 1 item</span></td>
                                <td><span class="amount-cell">₹1,299.00</span></td>
                                <td><span class="pay-pill pay-pending">Pending</span></td>
                                <td><span class="order-pill order-processing">Processing</span></td>
                                <td>
                                    <div class="date-cell">10 Jun 2026 <small>11:20 AM</small></div>
                                </td>
                                <td>
                                    <div style="display:flex;gap:5px">
                                        <a href="#" class="action-btn action-btn-view"><i class="fa fa-eye"></i></a>
