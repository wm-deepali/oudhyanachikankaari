...
<div class="main-section">
    ...
    .faq-create-page { background: var(--bg); padding: 24px 28px; min-height: 100vh; font-family: var(--font); color: var(--text-primary); }
    .faq-create-page * { box-sizing: border-box; }
    ...
    @media(max-width:768px) { .faq-create-page { padding: 16px; } }
    </style>
                        ...
                        <div class="section-card">
                            ...
                            <div class="section-card-body">
                                ...
                                <div class="field-group">
                                    ...
                                    <input type="text" name="question" class="field-input" required
                                        placeholder="e.g. What is your return policy?">
                                </div>

                                <div class="field-group">
                                    <label class="field-label">Answer <span class="req">*</span></label>
                                    <textarea name="answer" class="field-textarea" required
