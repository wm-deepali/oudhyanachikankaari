                ...
                <div class="section-card-body">
                    ...
                    <form method="POST" action="{{ route('admin.home.sliders.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="field-group">
                            <label class="field-label">Slider Image <span style="color:var(--red)">*</span></label>
                            <input type="file" name="image" class="field-input" accept=".jpg,.jpeg,.png,.webp" required>
