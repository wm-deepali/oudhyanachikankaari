...
:root {
    ...
    --text-hint:   #8c9196;
    --accent:      #303d89;          /* Shopify indigo-navy */
    --accent-light:#f0f1fc;
    --green:       #007a5e;
    --green-bg:    #e3f1ec;
    --amber:       #916a00;
...
.cardx:hover { box-shadow: 0 3px 10px rgba(0,0,0,.1), 0 0 0 1px var(--border); }

.cardx h1, .cardx h2, .cardx h3,
.cardx h4, .cardx h5, .cardx h6,
.cardx p, .cardx td, .cardx th, .cardx li {
    color: var(--text-primary) !important;
}
...
.kpi-card:hover { box-shadow: 0 3px 10px rgba(0,0,0,.1), 0 0 0 1px var(--border); }
...
.kpi-badge.info { background: var(--blue-bg);  color: var(--blue);  }
...
.progress-label span:last-child  { color: var(--text-primary);   font-weight: 600; }
...
.status-pill.processing { background: var(--blue-bg); color: var(--blue); }
.status-pill.processing::before { background: var(--blue); }
  ...
  <div class="container-fluid">
    <div class="content-area">
      ...
      <div class="revenue-banner">
        ...
        <div class="rev-num">
          <span>₹12,54,890</span>
          <small class="kpi-badge up" style="display:inline-flex;margin-top:4px;">
            <i class="fa fa-arrow-up"></i> 14.2% vs last month
          </small>
        </div>
      </div>
      ...
      <div class="row g-3 mb-4">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="kpi-card">
            ...
            <div style="display:flex;align-items:center;gap:8px">
              <span class="kpi-badge up"><i class="fa fa-arrow-up"></i> 12%</span>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="kpi-card">
            ...
            <div class="kpi-divider"></div>
            <div style="display:flex;align-items:center;gap:8px">
              <span class="kpi-badge up"><i class="fa fa-arrow-up"></i> 18%</span>
              <span class="kpi-sub">since last month</span>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="kpi-card">
            ...
            <div class="kpi-divider"></div>
            <div style="display:flex;align-items:center;gap:8px">
              <span class="kpi-badge info"><i class="fa fa-arrow-up"></i> 8%</span>
              <span class="kpi-sub">since last month</span>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="kpi-card">
            ...
            <div class="kpi-value">₹58,900</div>
            <div class="kpi-divider"></div>
            <div style="display:flex;align-items:center;gap:8px">
              <span class="kpi-badge warn"><i class="fa fa-clock"></i> Awaiting</span>
              <span class="kpi-sub">12 transactions</span>
            </div>
          </div>
        </div>
          ...
          <div class="cardx">
            <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px">
              ...
              <div style="display:flex;gap:6px">
                ...
                <span style="font-size:12px;color:var(--text-hint);padding:3px 8px;border-radius:20px;cursor:pointer;">Orders</span>
              </div>
            </div>
          ...
          <div class="cardx">
            ...
            <div class="progress-row">
              <div class="progress-label">
                <span>Pending</span><span>35%</span>
              </div>
              <div class="progress">
                <div class="progress-bar" style="width:35%;background:var(--amber)"></div>
              </div>
            </div>
            ...
            <div class="progress-row">
              ...
              <div class="progress">
                <div class="progress-bar" style="width:60%;background:var(--blue)"></div>
              </div>
            </div>

            <div class="progress-row">
              <div class="progress-label">
                <span>Delivered</span><span>90%</span>
              </div>
              <div class="progress">
                <div class="progress-bar" style="width:90%;background:var(--green)"></div>
              </div>
            </div>

            <div style="margin-top:24px;padding-top:16px;border-top:1px solid var(--border)">
              <div class="section-label" style="font-size:14px">Quick stats</div>
              <div style="display:flex;justify-content:space-between;font-size:13px;color:var(--text-secondary);margin-top:10px">
                <span>Avg. order value</span>
                <span style="font-weight:600;color:var(--text-primary)">₹1,520</span>
              </div>
              <div style="display:flex;justify-content:space-between;font-size:13px;color:var(--text-secondary);margin-top:8px">
                <span>Return rate</span>
                <span style="font-weight:600;color:var(--text-primary)">2.4%</span>
              </div>
              <div style="display:flex;justify-content:space-between;font-size:13px;color:var(--text-secondary);margin-top:8px">
        ...
        <div class="col-lg-8">
          <div class="cardx">
            ...
            <table class="dash-table">
              ...
              <tbody>
                <tr>
                  <td style="font-weight:600">#ORD001</td>
                  <td>
                    <div style="display:flex;align-items:center;gap:9px">
                      <div style="width:30px;height:30px;border-radius:50%;background:var(--accent-light);display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:700;color:var(--accent)">JS</div>
                      John Smith
                    </div>
                  </td>
                  <td style="font-weight:600">₹2,500</td>
                  <td><span class="status-pill delivered">Delivered</span></td>
                </tr>
                <tr>
                  <td style="font-weight:600">#ORD002</td>
                  <td>
                    <div style="display:flex;align-items:center;gap:9px">
                      <div style="width:30px;height:30px;border-radius:50%;background:var(--amber-bg);display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:700;color:var(--amber)">AK</div>
                      Amit Kumar
                    </div>
                  </td>
                  <td style="font-weight:600">₹4,200</td>
                  <td><span class="status-pill pending">Pending</span></td>
                </tr>
                <tr>
                  <td style="font-weight:600">#ORD003</td>
                  <td>
                    <div style="display:flex;align-items:center;gap:9px">
                      <div style="width:30px;height:30px;border-radius:50%;background:var(--blue-bg);display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:700;color:var(--blue)">SK</div>
                      Sara Khan
                    </div>
                  </td>
        ...
        <div class="col-lg-4">
          <div class="cardx">
            ...
            <div class="product-rank-item">
              ...
              <div class="qty">450</div>
            </div>
            <div class="product-rank-item">
              <div class="rank">2</div>
              <div class="name">Samsung S26</div>
              <div class="qty">390</div>
            </div>
            <div class="product-rank-item">
              <div class="rank">3</div>
              <div class="name">MacBook Pro</div>
              <div class="qty">280</div>
            </div>
            <div class="product-rank-item">
              <div class="rank">4</div>
              <div class="name">AirPods Pro</div>
              <div class="qty">250</div>
            </div>
          </div>
        </div>
