                    ...
                    <form method="POST" action="{{ route('admin.gallery-images.update', $galleryImage->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="field-group">
                            ...
                            <img src="{{ asset('storage/'.$galleryImage->image) }}" 
                                 class="current-image" alt="Current Gallery Image">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="field-group">
                                    <label class="field-label">Column <span style="color:var(--red)">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="field-group">
                                    <label class="field-label">Height Class <span style="color:var(--red)">*</span></label>
                        ...
                        <div class="action-bar">
                            <a href="{{ route('admin.gallery-images.index') }}" class="btn-secondary-dash">
                                Cancel
                            </a>
